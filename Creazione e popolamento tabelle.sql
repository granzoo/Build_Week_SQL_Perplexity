...
INSERT INTO categoria_prodotto VALUES
(1, 'Elettronica'),
(2, 'Abbigliamento'),
(3, 'Alimentari'),
(4, 'Giocattoli'),
...
-- PRODOTTI
INSERT INTO anagrafica_prodotto VALUES
(1, 'Smartphone X1', 'Smartphone di ultima generazione', 699.99, 1),
...
-- SOGLIE RESTOCK
INSERT INTO soglie_restock VALUES
(1, 1, 40),(1, 2, 60),(1, 3, 120),(1, 4, 30),(1, 5, 35),
(2, 1, 30),(2, 2, 50),(2, 3, 150),(2, 4, 25),(2, 5, 40),
(3, 1, 35),(3, 2, 45),(3, 3, 100),(3, 4, 20),(3, 5, 30);

-- GIACENZE
INSERT INTO giacenze VALUES
(1, 1, 50),(1, 2, 45),(1, 3, 80),(1, 4, 120),(1, 5, 200),
...
-- DETTAGLIO VENDITE
INSERT INTO dettaglio_vendita VALUES
(1, 1, 3, 699.99),(1, 5, 10, 1.99),(1, 7, 2, 49.99),
