...
-- categorie dei prodotti disponibili
CREATE TABLE categoria_prodotto (
    id_categoria INT PRIMARY KEY,
    nome_categoria VARCHAR(100) NOT NULL
);

-- dettagli utili sui prodotti
...
-- le giacenze disponibili a magazzino
...
-- il "restock level" associato ad ogni categoria di prodotti
...
-- dettagli utili sulle transazioni di vendita
...
-- dettagli approfonditi sulle transazioni di vendita
...
----------------------------------------------------------------------------
-- popoliamo le tabelle (con l'aiuto di Claude AI, anche se siamo team Perplexity (: ):
